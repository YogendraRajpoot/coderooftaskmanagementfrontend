    ...
    >
      ...
      <ul className="list-group mt-3 px-5">
        ...
        <li className="list-group-item py-2 mt-2">
          ...
          personal tasks, providing a seamless experience for managing your
          ideas.
        </li>
        <li className="list-group-item py-2 mt-2">
          Enhance Your Creativity: Our secure tasks platform empowers you to
        ...
        <li className="list-group-item py-2 mt-2">
          ...
          access your personal tasks whenever and wherever you need them.
        </li>
        <li className="list-group-item py-2 mt-2">
          Private and Confidential: We prioritize the privacy and
          confidentiality of your personal tasks, ensuring that your data is not
          shared or used for any unauthorized purposes. Your tasks are solely
